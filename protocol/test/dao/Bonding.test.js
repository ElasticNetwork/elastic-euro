...
describe('Bonding', function () {
  ...
  describe('frozen', function () {
    ...
    describe('when unbond', function () {
      ...
      describe('simple', function () {
        beforeEach(async function () {
          this.result = await this.bonding._unbond(new BN(1000).mul(INITIAL_STAKE_MULTIPLE), {from: userAddress});
          this.txHash = this.result.tx;
        });
      ...
      describe('partial', function () {
        beforeEach(async function () {
          this.result = await this.bonding._unbond(new BN(800).mul(INITIAL_STAKE_MULTIPLE), {from: userAddress});
          this.txHash = this.result.tx;
        });
    ...
    describe('when unbondUnderlying', function () {
      ...
      describe('simple', function () {
        beforeEach(async function () {
          this.result = await this.bonding._unbondUnderlying(1000, {from: userAddress});
          this.txHash = this.result.tx;
        });
      ...
      describe('partial', function () {
        beforeEach(async function () {
          this.result = await this.bonding._unbondUnderlying(800, {from: userAddress});
          this.txHash = this.result.tx;
        });
  ...
  describe('fluid', function () {
    ...
    describe('when deposit', function () {
      it('reverts', async function () {
        await expectRevert(this.bonding._deposit(1000, {from: userAddress}), "Permission: Not frozen");
      });
    });

    describe('when withdraw', function () {
      it('reverts', async function () {
        await expectRevert(this.bonding._withdraw(1000, {from: userAddress}), "Permission: Not frozen");
      });
    });
    ...
    describe('when unbond', function () {
      beforeEach(async function () {
        this.result = await this.bonding._unbond(new BN(500).mul(INITIAL_STAKE_MULTIPLE), {from: userAddress});
        this.txHash = this.result.tx;
      });
  ...
  describe('locked', function () {
    ...
    describe('when bond', function () {
      it('reverts', async function () {
        await expectRevert(this.bonding._bond(1000, {from: userAddress}), "Permission: Not frozen");
      });
    });

    describe('when unbond', function () {
      it('reverts', async function () {
        await expectRevert(this.bonding._unbond(1000, {from: userAddress}), "Permission: Not frozen");
      });
    });
  });
  ...
  describe('when step', function () {
    beforeEach(async function () {
      ...
      await this.bonding._bond(1000, {from: userAddress2});

      await time.increase(86400);
      await this.bonding.stepE({from: userAddress});

      /* Unbond User */
      await this.bonding._unbondUnderlying(2000, {from: userAddress});
