...
const EPOCH_START = 1600905600;
const EPOCH_PERIOD = 28800;
const BOOTSTRAPPING_PERIOD = 90;
const BOOTSTRAPPING_END_TIMESTAMP = EPOCH_START + (EPOCH_PERIOD * (BOOTSTRAPPING_PERIOD+1));
...
describe('State', function () {
  ...
  describe('erc20 details', function () {
    describe('name', function () {
      it('increments total bonded', async function () {
        expect(await this.setters.name()).to.be.equal("Elastic Euro Stake");
      });
    });

    describe('symbol', function () {
      it('increments total bonded', async function () {
        expect(await this.setters.symbol()).to.be.equal("eEURS");
      });
    });
  ...
  describe('epochTime', function () {
    ...
    describe('after one period', function () {
      beforeEach('call', async function () {
        await this.setters.setBlockTimestamp(BOOTSTRAPPING_END_TIMESTAMP + EPOCH_PERIOD);
      });
    ...
    describe('after many periods', function () {
      beforeEach('call', async function () {
        await this.setters.setBlockTimestamp(BOOTSTRAPPING_END_TIMESTAMP + (10 * EPOCH_PERIOD));
      });
    ...
    describe('one before update advance', function () {
      beforeEach('call', async function () {
        await this.setters.setBlockTimestamp(BOOTSTRAPPING_END_TIMESTAMP + (14 * EPOCH_PERIOD));
      });
    ...
    describe('right before update advance', function () {
      beforeEach('call', async function () {
        await this.setters.setBlockTimestamp(BOOTSTRAPPING_END_TIMESTAMP + (15 * EPOCH_PERIOD) - 1);
      });
    ...
    describe('at update advance', function () {
      beforeEach('call', async function () {
        await this.setters.setBlockTimestamp(BOOTSTRAPPING_END_TIMESTAMP + (15 * EPOCH_PERIOD));
      });
    ...
    describe('at first after update advance', function () {
      beforeEach('call', async function () {
        await this.setters.setBlockTimestamp(BOOTSTRAPPING_END_TIMESTAMP + (15 * EPOCH_PERIOD) + EPOCH_PERIOD);
      });
    ...
    describe('many after update advance', function () {
      beforeEach('call', async function () {
        await this.setters.setBlockTimestamp(BOOTSTRAPPING_END_TIMESTAMP + (15 * EPOCH_PERIOD) + (10 * EPOCH_PERIOD));
      });
